...
function SidebarTrigger({
  ...
  return (
    <Button
      ...
      className={cn(
        isMobile ? "gap-2 px-3 py-2 shrink-0" : "size-7",
        className
      )}
      onClick={(event) => {
        onClick?.(event)
      ...
      {...props}
    >
      <PanelLeftIcon className={isMobile ? "size-4" : undefined} />
      {isMobile ? (
        <span>Menu</span>
      ) : (
  ...
  return (
    <main
      ...
      className={cn(
        ...
        // min-width:auto, which makes it refuse to shrink below its widest
